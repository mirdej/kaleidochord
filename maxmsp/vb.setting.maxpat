	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "prepend read",
					"patching_rect" : [ 562.0, 422.0, 82.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "prepend write",
					"patching_rect" : [ 279.0, 430.0, 83.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 561.0, 397.0, 141.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "route set",
					"patching_rect" : [ 437.0, 499.0, 57.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sprintf symout %s/%s.txt",
					"patching_rect" : [ 279.0, 409.0, 141.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "text",
					"patching_rect" : [ 437.0, 470.0, 46.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 575.5, 313.5, 692.5, 313.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 571.5, 457.0, 446.5, 457.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 575.5, 232.0, 575.5, 313.0, 410.5, 313.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 288.5, 456.0, 446.5, 456.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-17", 0 ],
					"hidden" : 0,
					"midpoints" : [ 446.5, 524.0, 199.5, 524.0 ]
				}
